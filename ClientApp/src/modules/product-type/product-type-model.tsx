...
export default class ProductType implements SimpleModel, Entity {
  id!: number | null
  name!: string
  createdAt?: Date
  updatedAt?: Date
  ...
  constructor(data?: SimpleModel) {
    ...
    this.service = new ModelService<SimpleModel>('ProductTypes')
  }
  ...
  title(type: 'list' | 'form') {
    switch (type) {
      ...
      case 'form':
        if (!this.id) return 'Novo tipo de produto'
